...
class SACPolicy(nn.Module):
    ...
    def learn(self, data, fake_data):
        ...
        value_loss = self.compute_value_loss(true_value, true_value_target, tau=0.65)
        ...
        with torch.no_grad():
            next_q = self.true_valnet_old(next_obs)
        ...
        # with torch.no_grad():
        #     next_qf = self.true_valnet_old(next_fake_obs)
        #     target_qf = fake_rewards.flatten() + self._gamma * (1 - fake_terminals.flatten()) * next_qf.flatten()

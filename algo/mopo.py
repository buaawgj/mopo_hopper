...
class MOPO:
    ...
    def learn_dynamics(self):
        ...
        while not break_training:
            ...
            if updated:
                ...
                num_epochs_since_prev_best = 0
            if num_epochs_since_prev_best >= self.max_model_update_epochs_to_improve or model_train_iters > self.max_model_train_iterations or self.model_tot_train_timesteps > 600000:
                break
            # Debug
            break
    ...
    def learn_policy(self):
        ...
        fake_data = {
            "observations": fake_batch["observations"],
            "actions": fake_batch["actions"],
            "next_observations": fake_batch["next_observations"],
            "terminals": fake_batch["terminals"],
            "rewards": fake_batch["rewards"],
        }
        loss = self.policy.learn(data, fake_data)
        return loss

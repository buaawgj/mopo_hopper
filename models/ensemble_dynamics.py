...
class EnsembleModel(nn.Module):
    def __init__(self, obs_dim, action_dim, hidden_dims, device, ensemble_size=7, num_elite=5, decay_weights=None,
        ...
        self.ensemble_models = [
            MLPNetwork(
                input_dim=obs_dim + action_dim, out_dim=self.out_dim * 2, 
                hidden_dims=hidden_dims, act_fn=act_fn, out_act_fn=out_act_fn
    ...
    #         self.ensemble_models[i].load_state_dict(model.ensemble_models[i].state_dict())

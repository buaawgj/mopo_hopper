...
def train(args=get_args()):
    ...
    # model_path = "log/hopper-medium-v2/mopo/seed_1_1120_212114-hopper_medium_v2_mopo/models/ite_dynamics_model"
    # trainer.algo.dynamics_model.load_model(model_path, "model.pt")
